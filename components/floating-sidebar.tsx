...
export default function FloatingSidebar() {
    ...
    return (
        <div
            ...
            {/* Header with Logo */}
            <div className="flex items-center p-4 cursor-pointer relative border-b border-blue-200">
            ...
            <nav className="flex-1 p-2 space-y-1">
                {navigationItems.map((item) => (
                    <Link
                        ...
                        <span
                            className={cn(
                                "ml-3 text-sm font-medium transition-all duration-300 ease-in-out text-blue-900",
                                isExpanded
                                    ? "opacity-100 translate-x-0"
                                    : "opacity-0 -translate-x-4 pointer-events-none"
                            )}>
            ...
            <div className="p-2 border-t border-blue-200">
                {isSignedIn ? (
                    <button
                        className={cn(
                            "w-full flex items-center p-2 rounded-lg text-left transition-all duration-200 hover:bg-blue-50 hover:text-blue-700 group",
                    ...
                    <Button
                        className={cn(
                            "w-full justify-start transition-all duration-300 bg-blue-600 hover:bg-blue-700 text-white",
                            !isExpanded && "px-3"
                        )}
